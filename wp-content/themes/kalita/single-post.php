			...
			<div class="actualites-inner-img">
				<div class="row">
					<div class="col-md-8">
						...
						</span> <span class="dots"><i class="fa fa-square"></i></span><a class="post_comments" href="http://demo.qodeinteractive.com/bridge/inteligent-transitions-in-ux-design/#comments" target="_self">
						<?php
						//$comments_count = wp_count_comments( $post->ID );
						 //echo $comments_count->total_comments;?> Comments</a> <span class="dots"><i class="fa fa-square"></i></span>
								...
								<div class="share"> <a href="javascript:void(0)" class="share-icon" id="share-icons" title="Share"><span>Share</span></a> </div>
							</div>
